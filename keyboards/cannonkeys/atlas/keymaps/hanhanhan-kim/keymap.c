 ...
 *    v----------------------RGB CONTROLS-------------------------v
 * ,-----------------------------------------------------------------------------------.
 * | TOG  | MODE |RMODE |  HUD | HUI  | SAD  | SAI  | VAD  | VAI  |      |      |      |
 * |------+------+------+------+------+------+------+------+------+------+------+------|
 * | BOOT |      |      |      |      |      |      |      |      |      |      |      |
 * |------+------+------+------+------+------+------+------+------+------+------+------|
...
[_ADJUST] = LAYOUT_ortho_5x12(
  RGB_TOG, RGB_MOD, RGB_RMOD, RGB_HUD,  RGB_HUI, RGB_SAD,  RGB_SAI, RGB_VAD, RGB_VAI,_______, _______, _______,
...
[_GAMING] = LAYOUT_ortho_5x12(
  XXXXXXX, KC_1,    KC_2,    KC_3,    KC_4,    KC_5,       KC_6,       KC_7,    KC_8,    KC_9,    KC_0,     TO(_BASE),
  KC_TAB,  KC_Q,    KC_W,    KC_E,    KC_R,    KC_T,       KC_Y,       KC_U,    KC_I,    KC_O,    KC_P,     KC_BSPC,
