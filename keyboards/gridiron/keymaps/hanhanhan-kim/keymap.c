 ...
 * |------+------+------+------+------+------+------+------+------+------+------+------|
 * | CAD  | LCtrl| LGUI | LAlt | Lower| Space| Space| Raise| Left | Down |  Up  |Right |
 * `-----------------------------------------------------------------------------------'
 */
[_QWERTY] = LAYOUT_ortho_4x12(
    ...
    CAD,     KC_LCTL, KC_LGUI, KC_LALT, LOWER,   NAV_SPACE, NAV_SPACE,   RAISE,   KC_LEFT, KC_DOWN, KC_UP,    KC_RGHT
),
...
[_LOWER] = LAYOUT_ortho_4x12(
    ...
    RAND_STR, _______, _______, _______, _______, _______, _______, _______, _______,  _______, _______, _______
),
