 ...
 * |------+------+------+------+------+------+------+------+------+------+------+------|
 * |      |MUSmod|ROI_PSCR|Aud on|Audoff|AGnorm|AGswap|Qwerty|Colemk|Dvorak|Plover|    |
 * |------+------+------+------+------+------+------+------+------+------+------+------|
...
[_ADJUST] = LAYOUT_planck_grid(
    ...
    _______, MU_MOD, ROI_PSCR,  AU_ON,   AU_OFF,  AG_NORM, AG_SWAP, QWERTY,  COLEMAK,  DVORAK,  PLOVER,  _______,
