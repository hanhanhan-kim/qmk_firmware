...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
  [0] = LAYOUT(
        ...
        KC_LCTL,KC_LGUI,KC_LALT,          KC_SPC,                       TERMINAL_LIN,SFT_PSCR,KC_DEL,          KC_LEFT,KC_DOWN,KC_RGHT
    ),
  [1] = LAYOUT(
        ...
        _______,_______,_______,_______,_______,_______,_______,_______,_______,_______,_______,KC_MEDIA_PLAY_PAUSE,                   KC__VOLUP,
