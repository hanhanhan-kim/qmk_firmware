 ...
 * |------+------+------+------+------+------+------+------+------+------+------+------|
 * | Play | LCtrl| LGUI | LAlt | Lower|    Space    | Raise| Left | Down |  Up  |Right |
 * `-----------------------------------------------------------------------------------'
 */
 ...
 * |EEPROM|      |      |      |      |             |      |      |      |      | AUTO |
 * `-----------------------------------------------------------------------------------'
 * AUTO = autotmatically switch between USB and Bluetooth (so applicable only for Bluetooth builds)
 */
[_ADJUST] = LAYOUT_ortho_4x12(
    ...
    EEP_RST, _______, _______, _______, _______, _______, _______, _______, _______, _______, _______, OUT_AUTO
),
